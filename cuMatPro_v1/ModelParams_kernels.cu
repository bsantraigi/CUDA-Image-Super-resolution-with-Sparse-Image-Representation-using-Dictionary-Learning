...
void initGibbsParams(_modelParams* modelParams, _dlConfig* dlConfig, curandState_t* d_localstates)
{
	initGibbsParams_kernel << <1, 2 >> >(modelParams, dlConfig, d_localState);
}